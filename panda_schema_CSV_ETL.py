...
data_clean.to_csv('data-output/output_clean_data.txt', index=False)
data_clean_etl.to_csv('data-output/output_clean_data_etl.txt', index=False)
data_error.to_csv('data-output/output_error_data.txt', index=False)
# execution time
